...
// WorkerPoolWithDone returns channel of generic type `T` which excepts jobs of
// the same type for some number of workers that do workerFn. If you want to
// stop WorkerPool, close the jobQueue channel or close a `done` chan.
